...
const Footer = () => {
  ...
  return (
    <footer className="bg-Dark-Blue ">
      <div className="max-w-[1250px] mx-auto py-10 lg:py-20 px-4">
        <div className="flex flex-col-reverse lg:flex-row justify-between gap-6">
          <p className="text-Dark-Grayish-Blue lg:hidden text-center">
            Copyright 2020. All rights reserved.
          </p>
          <div className="flex flex-col-reverse lg:flex-col items-center lg:justify-between gap-10">
            <div>
              <svg xmlns="http://www.w3.org/2000/svg" width="146" height="24">
                <g fill="none">
                  <path
                    className="fill-Very-Pale-Red"
          ...
          <div className="flex justify-between gap-20 max-w-[19rem] mx-auto">
            {/* second column */}
            <ul className="flex flex-col gap-6 items-start">
              <li>
                <a
                  href=""
                  className="text-Very-Light-Gray font-medium hover:text-Bright-Red"
                >
                  Home
                </a>
              </li>
          ...
          {/* fourth column */}
          <div className="flex flex-col lg:items-end max-w-[30rem] mx-auto">
            <form
              onSubmit={handleSubmit}
              className="flex lg:items-end gap-2 max-w-[25rem] mx-auto lg:max-w-none"
            >
              <input
                type="email"
                placeholder="updates in your inbox.."
                className={`rounded-full py-3 px-4 w-full lg:w-[80%] outline-none`}
                value={email}
                onChange={(e) => setEmail(e.target.value)}
              />
              <button className="px-8 py-3 flex items-center justify-center text-base bg-Bright-Red rounded-full text-white hover:opacity-60">
                Go
              </button>
            </form>
            {error && (
              <p className="text-Bright-Red text-[0.8rem] text-left italic mt-2 ml-2 lg:mr-auto">
                {error}
              </p>
            )}

            <p className="text-Dark-Grayish-Blue lg:block hidden mt-auto">
              Copyright 2020. All rights reserved.
            </p>
          </div>
        </div>
